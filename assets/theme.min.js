       ...
       _createClass(ProductVariants, [{
         ...
         value: function _updateProductPrices(newVariant, previousVariant) {
           ...
           if (!newVariant) {
             ...
             console.log(localStorage.getItem('descProduct'))
             console.log(localStorage.getItem('SecdescProduct'))
             var currency = $(".priceNN").text();
               var number = Number(currency.replace(/[^0-9.-]+/g,""));
                var numVal1 = number;
                var numVal2 = localStorage.getItem('descProduct');
             
                var totalValue = numVal1 * ( (100-numVal2) / 100 )
                console.log("Precio Desuc", (numVal1-totalValue.toFixed(2)).toFixed(2))
                console.log(totalValue.toFixed(2))
                if(localStorage.getItem('descProduct') != localStorage.getItem('SecdescProduct')){
                    $("#timer_SingleProduct ul li").eq(1).html(""+localStorage.getItem('SecdescProduct')+"% OFF en 2 o más cuadros / "+localStorage.getItem('descProduct')+"% OFF en 1")
                 }else{
                    $("#timer_SingleProduct ul li").eq(1).html(""+localStorage.getItem('SecdescProduct')+"% OFF en toda la Tienda ")
                 }
                var result = totalValue.toFixed(2) * 1.204;
               var totalMeses = result / 12;
               console.log(result.toFixed(2))
               console.log(totalMeses.toFixed(2))
               var code=`
                 <style>
                    div.price-list {
                 ...
                 <div class="price-list"><span class="price price--highlight"><span class="visually-hidden">Sale Price</span><span
                    style="margin-right:5px">$</span> ${totalValue.toFixed(2)}</span><span class="price price--compare">
                     ${$(".priceNN").text()}</span>
                 </div>
                 <div id="save"
                    style="font-style: italic !important;color:#f02626!important;display: inline-flex !important;font-size: 15px !important;">
                    Ahorras $&nbsp;${(numVal1-totalValue.toFixed(2)).toFixed(2)} (<span style="line-height: 26px !important;">${numVal2}%</span>)
                 </div>
                 <span id="msi_holder" style="width:100%!important;clear:both!important;transform:translatey(-6px)!important;"><i
                    style="line-height: 1.2em !important; display: block !important; ">O 12 pagos de <strong>$&nbsp;${totalMeses.toFixed(2)}</strong>
                    (Total: $<strong class="pr">&nbsp;${result.toFixed(2)}</strong>)
                 </i></span>
               ...
               $(".product-form__info-content").html(code)
           }
         }
         /**
